...
// Serve uploads from UPLOAD_DIR or default to process.cwd()/attached_assets/uploads
const uploadDir = process.env.UPLOAD_DIR || path.join(process.cwd(), "attached_assets", "uploads");
